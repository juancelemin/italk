...
public class EditarNesecidadActivity extends AppCompatActivity implements View.OnClickListener, TextToSpeech.OnInitListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_editar_nesecidad);
        ...
        con1 = (ImageButton)findViewById(R.id.btnnesc1);
        con2 = (ImageButton)findViewById(R.id.btnnesc2);
        con3 = (ImageButton)findViewById(R.id.btnnesc3);
        con4 = (ImageButton)findViewById(R.id.btnnesc4);
        con5 = (ImageButton)findViewById(R.id.btnnesc5);
        con6 = (ImageButton)findViewById(R.id.btnnesc6);
        con7 = (ImageButton)findViewById(R.id.btnnesc7);
        salir = (ImageButton)findViewById(R.id.btnEnesBack);
    ...
    public void guardarFraseNueva (){
        SharedPreferences settings = getSharedPreferences("nesecidad", 0);
