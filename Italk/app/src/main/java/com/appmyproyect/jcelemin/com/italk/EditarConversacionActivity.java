...
public class EditarConversacionActivity extends AppCompatActivity implements View.OnClickListener, TextToSpeech.OnInitListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_editar_conversacion);
        ...
        con1 = (ImageButton)findViewById(R.id.btncon1);
        con2 = (ImageButton)findViewById(R.id.btncon2);
        con3 = (ImageButton)findViewById(R.id.btncon3);
        con4 = (ImageButton)findViewById(R.id.btncon4);
        con5 = (ImageButton)findViewById(R.id.btncon5);
        con6 = (ImageButton)findViewById(R.id.btncon6);
        con7 = (ImageButton)findViewById(R.id.btncon7);
        salir = (ImageButton)findViewById(R.id.btnEconBack);
